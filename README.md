...
```
$ git clone <yourrepo>
$ git remote add upstream <thisrepo>
```
...
$ vim js/main.js
```
When you're ready, [commit, merge any upstream cahnges, deal with conflicts, and push your branch](https://www.atlassian.com/git/tutorials/comparing-workflows/forking-workflow)   
```
